           ...
           <div class="row block">
             <div class="col-md-2 col-sm-2 s">.
               <div class="form-group input-group">
                 ...
                 <input type="text" data-date="<?php echo date('Y-m-d'); ?>" data-date-format="yyyy-mm-dd" name="arrival" id="date_pickerfrom" value="<?php echo date('m/d/Y'); ?>" readonly="true" class="date_pickerfrom input-sm form-control" min="<?php echo date('Y-m-d'); ?>">
