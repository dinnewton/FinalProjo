...
<form action="index.php?view=payment" method="post" name="personal">
  ...
  <div class="col-md-12">
    ...
    <div class="row">
      <div class="col-md-8 col-sm-4">
        ...
        <div class="col-md-12">
          ...
          <?php
            echo isset($_SESSION['city']) ? $_SESSION['city'] : '';
              echo isset($_SESSION['address']) && !empty($_SESSION['address']) ? ' ' . $_SESSION['address'] : '';
              ?>
        </div>
        <div class="col-md-12">
    ...
    <br>
    <div class="">
      <button a href="pesapal.php" type="submit" class="button" name="btnsubmitbooking">Submit Booking</button>
      <?php
