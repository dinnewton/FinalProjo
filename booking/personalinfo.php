...
if (isset($_POST['submit'])) {
	...
	// Validate email address and mobile number
	if (validate_email($_SESSION['cemail']) && validate_mobile($_SESSION['phone'])) {
		redirect('index.php?view=payment');
	} else {
		// Display error message if email or mobile number is invalid
		echo "Invalid email address or mobile number";
	}
} else {
	$arrival = "";
}
...
function validate_email($cemail)
{
	...
	return preg_match($pattern, $cemail);
}
...
<form class="form-horizontal" action="personalinfo.php" method="post" name="personal">
	...
	<div class="form-group  ">
		<!--<div class="col-md-12">
			...
			<div class="col-md-12 input-group">
				<input type="text" data-date="" data-date-format="yyyy-mm-dd" data-link-field="any" data-link-format="yyyy-mm-dd" name="dbirth" id="dbirth" value="" readonly="true" class="dbirth form-control  input-sm">
	...
	<div class="form-group">
		...
		<div class="form-group">
			<div class="col-md-12">
				<label class="col-md-4 control-label" for="cemail">E-MAIL:</label>
