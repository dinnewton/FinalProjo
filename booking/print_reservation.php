...
$result=$guest->single_guest($guestid);*/
  ...
  <form action="index.php?view=payment" method="post" name="">
    ...
    <p>
      ...
      Greetings from Bethel homestay<br /><br />
    ...
    <ul>
      <li>Function Room rate is Kshs; 500.00 for first four hours and kshs; 100.00 for each succeeding hours.</li>
      ...
      <br />
      Thank you for choosing Bethel homestay
      <br /><br />
